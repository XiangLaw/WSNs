...
void CoverageBoundHolePacketData::add(nsaddr_t id, double x, double y, double x_node, double y_node)
{
...
node CoverageBoundHolePacketData::get_intersect_data(int index)
{
    node re;
...
node CoverageBoundHolePacketData::get_node_data(int index) {
    node re;
    int offset = index * element_size_;

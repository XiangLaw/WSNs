...
Parabola::Parabola(const Point &focus, double baselineY) : _focus(focus), _baselineY(baselineY) {
...
ParabolaIntersectionSolutionSet::ParabolaIntersectionSolutionSet(const Point &point) : _type(ONE_SOLUTION),
                                                                                       _leftPoint(point),
                                                                                       _rightPoint(point) {
}

ParabolaIntersectionSolutionSet::ParabolaIntersectionSolutionSet(const Point &point1, const Point &point2) : _type(
        TWO_SOLUTIONS), _leftPoint(point1), _rightPoint(point2) {

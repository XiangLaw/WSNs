...
set opt(rp)             OCTAGON		;# routing protocol script (dsr or dsdv)
...
# Initialize the Octagon Routing Agent

Agent/OCTAGON set hello_period_ 500
Agent/OCTAGON set range_ 40
Agent/OCTAGON set broadcast_rate_ 1
Agent/OCTAGON set storage_opt_ 2
